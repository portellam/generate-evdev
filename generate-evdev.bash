...
# <params>
  ...
  declare -ar FILE_WATERMARK=(
    "# Generated by 'portellam/generate-evdev'"
    "# WARNING: Any modifications to this file will be modified by 'generate-evdev'"
    "#"
  )
  ...
  # <summary>Execution flags</summary>
    ...
    declare -g INCLUDE_HUGEPAGES=true
    declare -g RESTART_SERVICE=true
...
# <summary>Business functions</summary>
  ...
  function prepare_files
  {
    ...
    if ! "${UNDO_CHANGES}"; then
      ...
      if [[ -e "${file1_backup}" ]] \
        && ! rm --force "${APPARMOR_QEMU_DEST_PATH}"; then
  ...
  {
    local -a file1_output="${FILE_WATERMARK[@]}"
    file1_output+=(
      ""
      "### User permissions ###"
      "group = \"user\""
